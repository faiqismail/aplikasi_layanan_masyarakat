...
<?php
session_start();
if(!isset($_SESSION["email_admindesa"])){
echo "Login terlebih dahulu ";
exit;
}
$id_admindesa = $_SESSION["id_admindesa"];
$nama_admindesa = $_SESSION["nama_admindesa"];
?>
...
<a href="home_admindesa.php"id="active" >HOME</a>
...
<a href="javascript:void(0);" style="font-size:15px; " class="icon" onclick="NavBar()">&#9776;</a>
 ...
 <h3>Hello, <b><?=$nama_admindesa ?></b></h3><br>
