...
<?php
session_start();
if(!isset($_SESSION["email_masyarakat"])){
...
<a href="home_masyarakat.php" id="active">HOME</a>
...
<a href="index1.php" id="logout-button" >Logout</a>
...
<a href="javascript:void(0);" style="font-size:15px;" class="icon" onclick="NavBar()">&#9776;</a>
  ...
  <div class="container " style=" text-align: center;  margin-top: 50px"><br><br>
 ...
 <h3 >Hello, <b><?=$nama_masyarakat ?></b></h3><br>
...
function logout() {
            ...
            window.location.href = '/login'; // Mengarahkan pengguna ke halaman login
        }
