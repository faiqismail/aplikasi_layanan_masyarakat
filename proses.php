...
<a href="proses.php" id="active" >Proses</a>
           ...
           <tbody>
              ...
              foreach($data as $item_proses): ?>
               <tr>
                   ...
                   <td><?= $item_proses['telepon_masyarakat'] ?></td>
                   ...
                   <td>
                        <a href="edit_proses.php?id=<?= $item_proses['id_tanggapan'] ?>" class="btn btn-sm btn-warning">Edit</a>
                       
                    </td>
                   <td> <a href="fungsi/delete_proses.php?id=<?= $item_proses['id_tanggapan'] ?>" class="btn btn-sm btn-danger">delete</a></td>
